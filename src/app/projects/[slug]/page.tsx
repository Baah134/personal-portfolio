...
> = {
  ...
  hydrogel: {
    ...
    overview:
      "Evaluated the impact of dissolved ionic impurities (NaCl and MgCl2) on the water absorption and release kinetics of biodegradable starch-PVA-borax hydrogels. This research utilizes robust statistical testing (One-Way ANOVA, Tukey HSD, Bartlett's) to address soil-moisture retention challenges for Ghanaian farmers dealing with water pollution caused by illegal mining (galamsey).",
    problem:
    ...
    approach: [
      ...
      "Tested 2g hydrogel samples in NaCl and MgCl2 solutions at 5%, 10%, and 15% (w/v) concentrations, with distilled water as a control.",
      "Logged water absorption at 5-minute intervals for 1 hour and monitored release kinetics under 40°C incubator conditions.",
      "Performed KS-Limiting normality testing (p > 0.05) and Bartlett's test for homoscedasticity (p > 0.05) to validate parametric assumptions.",
    ...
    techStack: ["One-Way ANOVA", "Tukey HSD", "Bartlett Test", "Unpaired t-test", "Arduino", "Data Visualization", "IoT"],
    links: [
