...
> = {
  "bayesian-pid": {
    ...
    links: [
      { label: "GitHub Repository", href: "https://github.com/Baah134/iecon-2026-pid-bo-tuning" }
    ],
  },
  "metaverse-education": {
            ...
            {project.links && (
              <div className={styles.links} style={{ marginTop: 'var(--space-6)', display: 'flex', gap: 'var(--space-3)' }}>
                {project.links.map((link) => (
                  ...
                  >
                    {link.href.includes("github.com") || link.label.toLowerCase().includes("github") ? (
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={{ marginRight: '6px' }}>
