      ...
      <div className={`${styles.content} container`}>
        <div className={styles.grid}>
          ...
          <div className={styles.brand}>
            <h3 className={styles.brandName}>Prince Baah-Mensah</h3>
            <p className={styles.brandDesc}>
              Electrical &amp; Electronics Engineering student at Ashesi University.
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} Prince Baah-Mensah. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
